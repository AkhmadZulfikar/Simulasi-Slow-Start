...
set tracefd       [open NewReno5.tr w]
set windowVsTime2 [open winnewreno5.tr w]
set namtrace      [open NewReno5.nam w]
...
#set random waypoint manual set posisi dan pergerakan dengan pause time,
